...
@Component({
  selector: 'app-tags',
  template: `
    <div id="selectTag" (click)="onSelectedTag()"></div>
  `
})
...
@Component({
  ...
  template: `
    <div id="tabs" (click)="onSelectedType($event)">
...
describe('HomeComponent', () => {
  ...
  it('should load articles for not loggen in user', () => {
    ...
    expect(store.dispatch).toHaveBeenCalledWith(
      new ArticlesActions.ClearReturnArticlesConfig()
    );
    expect(store.dispatch).toHaveBeenCalledWith(
      new ArticlesActions.ResetConfig()
    );
    expect(store.dispatch).toHaveBeenCalledWith(
      new ArticlesActions.LoadTagsRequest()
    );
    expect(store.dispatch).toHaveBeenCalledWith(
  ...
  it('should load articles for loggen in user', () => {
    ...
    expect(store.dispatch).toHaveBeenCalledWith(
      new ArticlesActions.SetTypeOfFeed({ type: 'feed' })
    );
    expect(store.dispatch).toHaveBeenCalledWith(
      new ArticlesActions.LoadTagsRequest()
    );
  ...
  it('should load articles for loggen in user and return config', () => {
    ...
    expect(store.dispatch).toHaveBeenCalledWith(
      new ArticlesActions.SetTypeOfFeed({ type: returnConfig.type })
    );
    expect(store.dispatch).toHaveBeenCalledWith(
    ...
    expect(store.dispatch).toHaveBeenCalledWith(
      new ArticlesActions.SetTag({ tag })
    );
  ...
  it('should dispatch "ToggleArticleFavoriteRequest"', () => {
    ...
    expect(store.dispatch).toHaveBeenCalledWith(
      new ArticlesActions.SetTag({ tag: 'tag' })
    );
    expect(store.dispatch).toHaveBeenCalledWith(
      new ArticlesActions.LoadArticlesRequest()
    );
  ...
  it('should load article for sertain tab and set favorited', () => {
    ...
    expect(store.dispatch).toHaveBeenCalledWith(
      new ArticlesActions.SetTypeOfFeed({ type: 'notfeed' })
    );
    expect(store.dispatch).toHaveBeenCalledWith(
      new ArticlesActions.LoadArticlesRequest()
    );
