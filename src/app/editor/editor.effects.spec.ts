...
import { ArticlesService, Article, Errors } from '@app/core';
...
describe('AuthEffects', () => {
  ...
  describe('saveArticle$', () => {
    it('should call API to save article and return a "EditorArticleSaveSuccess", on success', () => {
      const action = new fromEditorActions.EditorArticleSaveRequest({
        article
      });
      const result = new fromEditorActions.EditorArticleSaveSuccess({
        article
      });
  ...
  describe('editorArticleSaveSuccess$', () => {
    it('should redirect to article on "EditorArticleSaveSuccess"', done => {
      const action = new fromEditorActions.EditorArticleSaveSuccess({
        article
      });

      actions$ = of(action);

      effects.editorArticleSaveSuccess$.subscribe(
        res => {
  ...
  describe('editorArticleSaveRequest$', () => {
    it('should show main loader on "EditorArticleSaveRequest"', done => {
      ...
      effects.editorArticleSaveRequest$.subscribe(
        res => {
  ...
  describe('editorArticleSaveFail$', () => {
    it('should hide main loader on "EditorArticleSaveFail"', done => {
      ...
      effects.editorArticleSaveFail$.subscribe(
        res => {
