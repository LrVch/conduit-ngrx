...
export class EditorEffects {
  ...
  saveArticle$ = this.actions$.pipe(
    ofType<EditorArticleSaveRequest>(
      EditorActionTypes.EditorArticleSaveRequest
    ),
    switchMap(action =>
      this.articleService.save(action.payload.article).pipe(
  ...
  editorArticleSaveSuccess$ = this.actions$.pipe(
    ofType<EditorArticleSaveSuccess>(
      EditorActionTypes.EditorArticleSaveSuccess
    ),
