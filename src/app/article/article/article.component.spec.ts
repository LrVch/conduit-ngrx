...
describe('ArticleComponent', () => {
  ...
  it('should dispatch "ArticleCommentsRequest', () => {
    ...
    expect(store.dispatch).toHaveBeenCalledWith(
      new ArticleActions.ArticleCommentsRequest({ slug: 'slug' })
    );
  });
  ...
  it('should dispatch "ArticleToggleFollowingRequest"', () => {
    ...
    expect(store.dispatch).toHaveBeenCalledWith(
      new ArticleActions.ArticleToggleFollowingRequest({ profile })
    );
  });
  ...
  it('should dispatch "ToggleArticleFavoriteRequest"', () => {
    ...
    expect(store.dispatch).toHaveBeenCalledWith(
      new ToggleArticleFavoriteRequest({ article })
    );
  });
  ...
  it('should dispatch "ArticleCommentAddRequest"', () => {
    ...
    expect(store.dispatch).toHaveBeenCalledWith(
      new ArticleActions.ArticleCommentAddRequest({ comment: 'comment' })
    );
  });
  ...
  it('should dispatch "ArticleCommentDeleteRequest"', () => {
    ...
    expect(store.dispatch).toHaveBeenCalledWith(
      new ArticleActions.ArticleCommentDeleteRequest({ comment })
    );
  });
  ...
  it('should dispatch "LogoutAction"', () => {
    ...
    expect(store.dispatch).toHaveBeenCalledWith(
      new AuthActions.LogoutAction({ path: 'register' })
    );
  });
});
