...
describe('AuthEffects', () => {
  ...
  describe('taggleFollowUserProfile$', () => {
    it('should return "SetFollowingProfile" if user isn\'t logged in', () => {
      const action = new fromProfileActions.ProfileToggleFollowingRequest({
        profile
      });
    ...
    it('should return "ProfileUnFollowingRequest" if profile is followed already', () => {
      ...
      const result = new fromProfileActions.ProfileUnFollowingRequest({
        profile
      });
    ...
    it('should return "ProfileFollowingRequest" if profile isn\'t followed', () => {
      ...
      const result = new fromProfileActions.ProfileFollowingRequest({
        profile
      });
  ...
  describe('profileFollowing$', () => {
    it('should call API to follow user(show notification) and return a "ProfileToggleFollowingSuccess", on success', () => {
      const action = new fromProfileActions.ProfileFollowingRequest({
        profile
      });
      const result = new fromProfileActions.ProfileToggleFollowingSuccess({
        profile,
  ...
  describe('profileToggleFollowingSuccess$', () => {
    it('should show notification on "ProfileToggleFollowingSuccess"', done => {
      const action = new fromProfileActions.ProfileToggleFollowingSuccess({
        profile
      });

      actions$ = of(action);

      effects.profileToggleFollowingSuccess$.subscribe(
        res => {
