...
describe('Article Reducer', () => {
  ...
  describe('State changes', () => {
    ...
    it('should have an initial state', () => {
      const state = fromArticlesConfig.articlesConfigReducer(initialArticleConfigState, { type: '@@init' } as any);
    ...
    it('should type as "all" on "SetTag"', () => {
      ...
      const state = [init, action].reduce(fromArticlesConfig.articlesConfigReducer, initialArticleConfigState);
