...
describe('AuthEffects', () => {
  ...
  describe('loadArticles$', () => {
    it('should call API to load article and return a "LoadArticlesLoaded", on success', () => {
      ...
      const result = new fromArticlesActions.LoadArticlesLoaded({
        articles: a
      });

      actions$ = hot('-a', { a: action });
      const response = cold('-b', {
        b: { articles: responseArticles, articlesCount: 2 }
      });
  ...
  describe('taggleFavoriteArticle$', () => {
    it('should return "SetFollowingProfile" if user isn\'t logged in', () => {
      const action = new fromArticlesActions.ToggleArticleFavoriteRequest({
        article
      });
    ...
    it('should return "UnFavoriteArticleRequest" if the article is favorited already', () => {
      ...
      const result = new fromArticlesActions.UnFavoriteArticleRequest({
        article
      });
    ...
    it('should return "FavoriteArticleRequest" if the article isn\'t favorited', () => {
      ...
      const result = new fromArticlesActions.FavoriteArticleRequest({
        article
      });
  ...
  describe('favoriteArticle$', () => {
    it('should call API to favorite article(show notification) and return a "ToggleArticleFavoriteSuccess", on success', () => {
      const action = new fromArticlesActions.FavoriteArticleRequest({
        article
      });
      const result = new fromArticlesActions.ToggleArticleFavoriteSuccess({
        article,
    ...
    it('should call API to favorite article(show notification) and return a "ToggleArticleFavoriteFail", on fail', () => {
      ...
      const result = new fromArticlesActions.ToggleArticleFavoriteFail({
        article,
        showNotification: true
      });
  ...
  describe('unFavoriteArticle$', () => {
    it('should call API to unfavorite article and return a "ToggleArticleFavoriteSuccess", on success', () => {
      const action = new fromArticlesActions.UnFavoriteArticleRequest({
        article
      });
      const result = new fromArticlesActions.ToggleArticleFavoriteSuccess({
        article
  ...
  describe('toggleArticleFavoriteSuccess$', () => {
    it('should show notification on "ToggleArticleFavoriteSuccess"', done => {
      const action = new fromArticlesActions.ToggleArticleFavoriteSuccess({
        article
      });

      actions$ = of(action);

      effects.toggleArticleFavoriteSuccess$.subscribe(
        res => {
